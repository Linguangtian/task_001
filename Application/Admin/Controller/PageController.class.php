...
class PageController extends AdminBaseController{
    ...
    public function handle() {
        ...
        if( IS_POST ) {
            ...
            $data['index_notice'] = intval(I('post.index_notice'));
            $id = $data[$model->getPk ()];
    ...
    public function message(){
        $list = $this->_list ('member_message', '','','is_read asc',20);
        $this->assign('list',$list);
        $this->display();
    ...
    public function messageRead(){
      ...
      $map=['is_read'=>1];
      M('member_message')->where('id ='.$id)->save($map);
      $this->error('1');
    ...
    public function messageDel(){
        ...
        M('member_message')->where('id ='.$id)->delete();
        $this->success('1');
    }
