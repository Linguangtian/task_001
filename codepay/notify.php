...
if (!$_POST['pay_no'] || md5($sign . $codepay_key) != $_POST['sign']) { //不合法的数据
    ...
    if ($result == 'ok' || $result == 'success') { //返回的是业务处理完成
        $codepay_config['go_url'] =   $codepay_config['go_url'].'/index.php/Home/Public/complete/id/'.$_POST['pay_id'];
...
}////www.renwu1.com/index.php/Home/Public/complete/id/VIPD315749527816661007392
//http://www.renwu1.com/codepay/notify.php?id=176651479237&userID=525847&pay_no=2020052722001483391403868868&pay_id=VIPD315749527816661007392&price=0.01&status=0&trade_no=1159058158515258474596088114&endTime=1590581945&trueID=525847&mode=0&notify_count=0&qr_user=0&ok=1&type=1&money=0.01&pay_time=1590581596&tag=0&target=get&codepay_server_time=1590581605&sign=e5572aeca173419b6d46e2c3518efc62
